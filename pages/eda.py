...
def edaLayout(inputDict):
    ...
    metric_dropdown = dcc.Dropdown(options=[{"label":"Overall MPI Index of States","value":"overall_mpi_index"},
                                           ...
                                           value=inputDict["value_eda_all_states_metric_dropdown"],
                                           id="eda_all_states_metric_dropdown",
                                           maxHeight=175)

    radio_bottons = dcc.RadioItems(id='eda_radio-buttons',
        options=[
    ...
    if inputDict["value_eda_all_states_metric_dropdown"]=='overall_mpi_index':
    ...
    if inputDict["value_eda_all_states_metric_dropdown"] in ['Orignal_Illiterate population (%)',
        ...
        var1 = inputDict["value_eda_all_states_metric_dropdown"]
    ...
    if inputDict["value_eda_all_states_metric_dropdown"]=='distribution_indicators':
    ...
    graph_figure = dcc.Graph(figure=fig,id="eda_all_states_graph_hover")  
    graph_div = html.Div([graph_figure],id="eda_all_states_graph_div")
    all_state_box = html.Div([metric_dropdown,graph_div ],id="eda_all_state_box")
    ...
    # plot graph
    selected_state = inputDict["value_eda_all_states_graph_hover"]
    ...
    card_box_1 = html.Div(card_row_1,id="eda_card_box_1")
    card_box_2 = html.Div(card_row_2,id="eda_card_box_2")
    ...
    card_box_both = html.Div([card_box_1,card_box_2],id="eda_card_box_both")
    card_box_all = html.Div([card_box_3,card_box_both],id="eda_card_box_all")
    ...
    selected_state_metric = html.Div([html.Div([selected_state]),
                                      ...
                                      html.Div([selected_state_mpi_rank])],id="eda_selected_state_metric")

    graph_figure_state_heading = html.P("Indicator Contribution in MPI",id="graph_figure_state_heading")
    state_wise_box = html.Div([selected_state_metric,graph_figure_state_heading,graph_figure_state],id="eda_state_wise_box")
    # final layout
...
layout = edaLayout(inputdict)

@callback(
    Output(component_id='analytics-output', component_property='children'),
    [Input(component_id="eda_all_states_metric_dropdown", component_property='value'),
    Input(component_id="eda_all_states_graph_hover", component_property='clickData')])

def update_function(value_eda_all_states_metric_dropdown,
                    value_eda_all_states_graph_hover):
    inputdict["value_eda_all_states_metric_dropdown"]=value_eda_all_states_metric_dropdown
    #inputdict["value_eda_radio_buttons"]=value_eda_radio_buttons
    if value_eda_all_states_graph_hover is not None:
        inputdict["value_eda_all_states_graph_hover"] = value_eda_all_states_graph_hover['points'][0]["label"]
    
    return edaLayout(inputdict)